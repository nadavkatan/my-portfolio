...
const ProjectsStripe = () => {
    ...
    const earpongSubtitle= "Earpong! is an ear-training app for users to practice their relative pitch recognition. The app generates random sounds for the user to try and recognize. It is based on a famous ear-training exercise used in music colleges. Earpong! is a rather simple React app, one of the first ones that I have developed, but I love it! It was built with React, Materia Ui, and Tone.js";
    const earpongStyled = "Click the 'Play sound' button, listen carefully and try to recognize whether the played sound is 'C' or 'G'. Submit your answer by clicking the corresponding sound button. If you're correct, you will be redirected to the live project, if you're wrong, to the source code.";

    return (
    <>
    <div className="project-container">
        <ProjectSpecs letter="S" title="pyke" transform={-43} subtitle={spykeSubtitle} styledText={spykeStyled}/>
        <Spyke/>
    </div>
        <div className="project-container">
        <Shilo/>
        <ProjectSpecs letter="S" title="hilo" transform={-43} subtitle={shiloSubtitle} styledText={shiloStyled}/>
    </div>
    <div className="project-container">
        <ProjectSpecs pecs letter="E" title="arpong!" transform={-36} subtitle={earpongSubtitle} styledText={earpongStyled}/>
        <Earpong/>
    </div>
    <BackgroundHome/>
    </>
